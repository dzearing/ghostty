...
final class LocalAgentManager {
    ...
    /// CLAUDE.md's mandatory-update prompt is reserved for a skew the handshake
    ...
    /// (CLAUDE.md's mandatory-update process). A merely older-but-compatible
    ...
    ///
    /// This is CLAUDE.md's mandatory-update mechanism, kept intact and reachable
