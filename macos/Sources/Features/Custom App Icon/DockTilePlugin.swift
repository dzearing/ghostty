...
class DockTilePlugin: NSObject, NSDockTilePlugIn {
    ...
    #if DEBUG
    private let ghosttyUserDefaults = UserDefaults(suiteName: "com.dzearing.ghoztty.debug")
    #else
    private let ghosttyUserDefaults = UserDefaults(suiteName: "com.dzearing.ghoztty")
    #endif
