...
extension Ghostty {
    ...
    static let userNotificationCategory = "com.dzearing.ghoztty.userNotification"

    // The user notification "Show" action
    static let userNotificationActionShow = "com.dzearing.ghoztty.userNotification.Show"
}
...
extension Notification.Name {
    ...
    static let ghosttyConfigDidChange = Notification.Name("com.dzearing.ghoztty.configDidChange")
    static let GhosttyConfigChangeKey = ghosttyConfigDidChange.rawValue

    /// Color change. Object is the surface changing.
    static let ghosttyColorDidChange = Notification.Name("com.dzearing.ghoztty.ghosttyColorDidChange")
    static let GhosttyColorChangeKey = ghosttyColorDidChange.rawValue

    /// Goto tab. Has tab index in the userinfo.
    static let ghosttyMoveTab = Notification.Name("com.dzearing.ghoztty.moveTab")
    static let GhosttyMoveTabKey = ghosttyMoveTab.rawValue

    /// Close tab
    static let ghosttyCloseTab = Notification.Name("com.dzearing.ghoztty.closeTab")

    /// Close other tabs
    static let ghosttyCloseOtherTabs = Notification.Name("com.dzearing.ghoztty.closeOtherTabs")

    /// Close tabs to the right of the focused tab
    static let ghosttyCloseTabsOnTheRight = Notification.Name("com.dzearing.ghoztty.closeTabsOnTheRight")

    /// Close window
    static let ghosttyCloseWindow = Notification.Name("com.dzearing.ghoztty.closeWindow")

    /// Resize the window to a default size.
    static let ghosttyResetWindowSize = Notification.Name("com.dzearing.ghoztty.resetWindowSize")

    /// Ring the bell
    static let ghosttyBellDidRing = Notification.Name("com.dzearing.ghoztty.ghosttyBellDidRing")

    /// Readonly mode changed
    static let ghosttyDidChangeReadonly = Notification.Name("com.dzearing.ghoztty.didChangeReadonly")
    static let ReadonlyKey = ghosttyDidChangeReadonly.rawValue + ".readonly"
    static let ghosttyCommandPaletteDidToggle = Notification.Name("com.dzearing.ghoztty.commandPaletteDidToggle")

    /// Toggle maximize of current window
    static let ghosttyMaximizeDidToggle = Notification.Name("com.dzearing.ghoztty.maximizeDidToggle")

    /// Notification sent when scrollbar updates
    static let ghosttyDidUpdateScrollbar = Notification.Name("com.dzearing.ghoztty.didUpdateScrollbar")
    static let ScrollbarKey = ghosttyDidUpdateScrollbar.rawValue + ".scrollbar"

    /// Focus the search field
    static let ghosttySearchFocus = Notification.Name("com.dzearing.ghoztty.searchFocus")
}
...
extension Ghostty.Notification {
    ...
    static let NewSurfaceConfigKey = "com.dzearing.ghoztty.newSurfaceConfig"

    /// Posted when a new split is requested. The sending object will be the surface that had focus. The
    /// userdata has one key "direction" with the direction to split to.
    static let ghosttyNewSplit = Notification.Name("com.dzearing.ghoztty.newSplit")

    /// Close the calling surface.
    static let ghosttyCloseSurface = Notification.Name("com.dzearing.ghoztty.closeSurface")

    /// Focus previous/next split. Has a SplitFocusDirection in the userinfo.
    static let ghosttyFocusSplit = Notification.Name("com.dzearing.ghoztty.focusSplit")
    ...
    static let ghosttySwapSplit = Notification.Name("com.dzearing.ghoztty.swapSplit")
    static let SwapSplitDirectionKey = ghosttySwapSplit.rawValue

    /// Goto tab. Has tab index in the userinfo.
    static let ghosttyGotoTab = Notification.Name("com.dzearing.ghoztty.gotoTab")
    static let GotoTabKey = ghosttyGotoTab.rawValue

    /// New tab. Has base surface config requested in userinfo.
    static let ghosttyNewTab = Notification.Name("com.dzearing.ghoztty.newTab")

    /// New window. Has base surface config requested in userinfo.
    static let ghosttyNewWindow = Notification.Name("com.dzearing.ghoztty.newWindow")

    /// Present terminal. Bring the surface's window to focus without activating the app.
    static let ghosttyPresentTerminal = Notification.Name("com.dzearing.ghoztty.presentTerminal")

    /// Toggle fullscreen of current window
    static let ghosttyToggleFullscreen = Notification.Name("com.dzearing.ghoztty.toggleFullscreen")
    static let FullscreenModeKey = ghosttyToggleFullscreen.rawValue

    /// Notification sent to toggle split maximize/unmaximize.
    static let didToggleSplitZoom = Notification.Name("com.dzearing.ghoztty.didToggleSplitZoom")

    /// Notification sent to toggle hero mode.
    static let didToggleHeroMode = Notification.Name("com.dzearing.ghoztty.didToggleHeroMode")

    /// Notification
    static let didReceiveInitialWindowFrame = Notification.Name("com.dzearing.ghoztty.didReceiveInitialWindowFrame")
    static let FrameKey = "com.dzearing.ghoztty.frame"

    /// Notification to render the inspector for a surface
    static let inspectorNeedsDisplay = Notification.Name("com.dzearing.ghoztty.inspectorNeedsDisplay")

    /// Notification to show/hide the inspector
    static let didControlInspector = Notification.Name("com.dzearing.ghoztty.didControlInspector")

    static let confirmClipboard = Notification.Name("com.dzearing.ghoztty.confirmClipboard")
    ...
    static let didResizeSplit = Notification.Name("com.dzearing.ghoztty.didResizeSplit")
    ...
    static let didEqualizeSplits = Notification.Name("com.dzearing.ghoztty.didEqualizeSplits")

    /// Notification that renderer health changed
    static let didUpdateRendererHealth = Notification.Name("com.dzearing.ghoztty.didUpdateRendererHealth")

    /// Notifications related to key sequences
    static let didContinueKeySequence = Notification.Name("com.dzearing.ghoztty.didContinueKeySequence")
    static let didEndKeySequence = Notification.Name("com.dzearing.ghoztty.didEndKeySequence")
    static let KeySequenceKey = didContinueKeySequence.rawValue + ".key"

    /// Notifications related to key tables
    static let didChangeKeyTable = Notification.Name("com.dzearing.ghoztty.didChangeKeyTable")
