...
17. ~~T89e~~ — DONE 2026-07-20 (close-vs-quit: user close ⇒ CLOSE via
   ...
   IPC splits unblocked). **Next on-box: T89f** (same-PID re-attach restore;
   folds with T96's production pty teardown for the close path). T29/T30/T87
   remain Mac-seat.
