...
20. **PUBLISH-READINESS QUEUE (user directive 2026-07-20, standing): work
    ...
    T111b row. **JUMPED AHEAD OF T111b, 2026-07-21: ~~T112~~ DONE** — the
    ...
    boundary was itself the end-to-end validation). T111b is UNCHANGED and is
    the next task. Gap it surfaced: **T113** (win32 never exports
