...
17. ~~T89e~~ — DONE 2026-07-20 (close-vs-quit: user close ⇒ CLOSE via
   ...
   **T89f2** (launch restore + ATTACH + suppress blank window). **T89f1 DONE
   ...
   write-half ALL PASS ×3). **Next on-box: T89f2** (still folds with T96's
   production pty teardown on the close path). T29/T30/T87 remain Mac-seat.
