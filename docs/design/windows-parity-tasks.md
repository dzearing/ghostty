...
3e. **USER LIVE-REVIEW, 2026-07-29 — do these FIRST, ahead of 3d.** The user
   ...
   Mac-parity: **T139** (single-instance guard + watchdog — the loop must never
   fork, and must not stay dead when it does) → **T138** (the upgrade script is
   what forked it) → **T141** (delete the Windows-only `+relay-login`/
