...
| T78 | `window-title-font-family` — done 2026-07-18: drives the owner-drawn tab bar font + resize overlay (DWM caption font is not app-controllable; Windows-native scope), live config reload; pure title_font.zig (unit tests both lanes); `title-font.ps1` ALL PASS (9) ×3 (T51 F14) | I | — | done | (this commit) |
