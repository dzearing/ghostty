...
3d. **NEXT, in this order** (user-reported live 2026-07-28, ahead of the item-20
   ...
   proven) → **T131** (banner overlay: content scrolls behind it, and Mac has
   since moved to a rounded/shadowed card) → **T130** (make the plugin-side
   banner-hook fixes durable) → **T133** (same, for the `/reset-context`
   composer wipe) → T38/T39 per item 20.
