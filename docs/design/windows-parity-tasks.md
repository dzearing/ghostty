...
20. **PUBLISH-READINESS QUEUE (user directive 2026-07-20, standing): work
    ...
    DIFFERENT, now-measured mechanism and are split out as **T115 (DO THIS
    NEXT — publish blocker: `+close` blocks the GUI thread 64883ms in
    teardown, E11/E12; a regression T111b unmasked by removing the
    throttle) → T114 (publish blocker: `+read` loses ~190 consecutive lock
    races, E4)**. **JUMPED AHEAD OF T111b, 2026-07-21: ~~T112~~ DONE** — the
