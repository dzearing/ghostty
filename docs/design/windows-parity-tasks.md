...
17. ~~T89c~~ — DONE 2026-07-20 (agent `--listen-pipe` + `+sessions` pipe
   ...
   **T89d1** (split out of T89d, done 2026-07-20: the single-instance note
   ...
   failures (proven on baseline; both app lanes green). This blocks the
   standing test-agent bar for every task; clear T97 (or run it down) when
   the agent floor matters.
