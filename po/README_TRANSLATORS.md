...
file called `com.dzearing.ghoztty.pot`. **Do not edit this file.** The
...
```console
$ msginit -i po/com.dzearing.ghoztty.pot -l X -o "po/X.po"
```
...
```diff
 ...
 /po/com.dzearing.ghoztty.pot @ghostty-org/localization
